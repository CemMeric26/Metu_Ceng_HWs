...
private: // YOU MAY ADD YOUR OWN UTILITY MEMBER FUNCTIONS HERE.
    void searchFlight(BSTNode<Flight> *r,std::vector<Flight *> &result,const std::string &departureCity, const std::string &arrivalCity);
    void flight_pointer(BSTNode<Flight> *r,const std::string &flightCode,BSTNode<Flight> *&n);
