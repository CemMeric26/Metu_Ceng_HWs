...
## abscopy.ys code!
##MODIFICATIONS
#I implemented "isubq" instruction since for substraction , processor
# is able to make faster computations with constants than Registers
# therefore i implemented and used it in negate operation
####################################################################
...
bool instr_valid = f_icode in 
	{ INOP, IHALT, IRRMOVQ, IIRMOVQ, IRMMOVQ, IMRMOVQ,
	  IOPQ, IJXX, ICALL, IRET, IPUSHQ, IPOPQ, IISUBQ };		#done by me
...
bool need_regids =
	f_icode in { IRRMOVQ, IOPQ, IPUSHQ, IPOPQ, 
	     IIRMOVQ, IRMMOVQ, IMRMOVQ, IISUBQ };		#done by me

# Does fetched instruction require a constant word?
bool need_valC =
f_icode in { IIRMOVQ, IRMMOVQ, IMRMOVQ, IJXX, ICALL, IISUBQ };		#done by me
...
word d_srcB = [
D_icode in { IOPQ, IRMMOVQ, IMRMOVQ, IISUBQ  } : D_rB;		#done by me
...
word d_dstE = [
	D_icode in { IRRMOVQ, IIRMOVQ, IOPQ, IISUBQ} : D_rB;		#done by me
	D_icode in { IPUSHQ, IPOPQ, ICALL, IRET } : RRSP;
...
word aluA = [
	...
	E_icode in { IISUBQ } : E_valB;			#done by me
...
E_icode in { IISUBQ } : E_valC;		#done by me
...
word alufun = [
	E_icode == IOPQ : E_ifun;
	E_icode == IISUBQ : ALUSUB;			#done by me
	1 : ALUADD;
];
...
bool set_cc = E_icode == IOPQ &&
	...
	E_icode == IISUBQ &&
	# State changes only during normal operation
	!m_stat in { SADR, SINS, SHLT } && !W_stat in { SADR, SINS, SHLT } ; #done by me
